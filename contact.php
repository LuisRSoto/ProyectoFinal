...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="email" name="email" required placeholder="ingresa tu correo electrónico" class="box">
      <input type="number" name="number" required placeholder="ingresa tu número" class="box">
