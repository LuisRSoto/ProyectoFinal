...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('¿Eliminar este producto del carrito?');"></a>
   ...
   <div style="margin-top: 2rem; text-align:center;">
      <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('¿Eliminar todo del carrito?');">eliminar todo</a>
   </div>

   <div class="cart-total">
      <p>total general : <span>$<?php echo $grand_total; ?>/-</span></p>
      <div class="flex">
